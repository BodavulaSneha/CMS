        ...
        <Content>
            <AssignmentsContent>
                ...
                <AddAssignmentForm onSubmit={handleAddAssignment}>
                    ...
                    <AddAssignmentTextArea type='text' 
                    placeholder='Enter assignment description'
                    value={newAssignment.description} onChange={(e) => setNewAssignment({...newAssignment, description: e.target.value})}/>
                    <AddAssignmentInput type='text' placeholder='Enter assignment grade' value={newAssignment.grade} onChange={(e) => setNewAssignment({...newAssignment, grade: e.target.value})}/>
                    <AddAssignmentInput type='text' placeholder='Enter Assignment deadline' value={newAssignment.deadline} onChange={(e) => setNewAssignment({...newAssignment, deadline: e.target.value})}/>
                    <AddAssignmentButton type>Add Assignment</AddAssignmentButton>
                </AddAssignmentForm>
                <AssignmentList>
